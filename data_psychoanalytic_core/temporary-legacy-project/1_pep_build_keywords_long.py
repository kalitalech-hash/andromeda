...
SLEEP = 0.8          # grzeczne tempo
TIMEOUT = 60
PAGE_LIMIT = 200     # jeśli API pozwoli (czasem max 200/500)
...
def build_headers(secrets: dict):
    # minimalny zestaw nagłówków – reszta nie jest potrzebna
    h = {
...
def main():
    ...
    # Wklej tu URL requesta SEARCH z Network (sam URL, bez -H)
    ...
    # Ustawiamy format JSON (w razie gdyby było XML)
